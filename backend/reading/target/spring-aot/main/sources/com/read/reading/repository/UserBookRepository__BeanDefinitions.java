...
/**
 * Bean definitions for {@link UserBookRepository}.
 */
@Generated
public class UserBookRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'userBookRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getUserBookRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'userBookRepository'.
   */
  public static BeanDefinition getUserBookRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, UserBookRepository.class, UserBook.class, UserBookId.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.read.reading.repository.UserBookRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.UserBookRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.read.reading.repository.UserBookRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getUserBookRepositoryInstanceSupplier();
